...
class AuthoredPost < ActiveRecord::Base
  self.table_name = "posts"
  include Revisable::Model
  revisable :title, :body, author: -> { Current.user }
end
